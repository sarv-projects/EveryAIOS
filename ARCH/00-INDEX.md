...
> **Status:** v1.0 (architecture design, 2026-08-06; re-verified 2026-08-21; **agent control plane frozen v3.47 — 2026-08-23**) · Works alongside the **master spec `../DESKTOP-APP-SPEC.md` (now v3.51 — see `SPEC-CHANGELOG.md`)** — this ARCH series adds the research-derived Rust layer; the two stay in sync (09 mirrors spec §0).
...
> Historical reconciliation (columns describe earlier spec generations; the **live master spec is `desktop_app/DESKTOP-APP-SPEC.md` v3.51 — hybrid**, in sync with this ARCH).
