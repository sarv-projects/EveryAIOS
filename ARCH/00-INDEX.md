...
12. **12-UI-SPEC.md** — UI/UX specification **v2.0**: 48px activity rail + one-surface views (Folder/Shell/Browse/Code + ONE Office flyout + session views + plugin slot), views contract, takeover/resume, per-session layout persistence (2026 work-cockpit pattern — Claude Views/Cursor/ChatGPT Work/Devin, doc 67 §6)
