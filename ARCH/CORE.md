...
| **V4** | A TypeScript package stores provider credentials, against the vault rule | `packages/core-providers/src/vault.ts` — `ProviderVault` seals/unseals API keys via `@personal-ai/core-security` (`:88`, `:147`) | **I10** (the most serious) |
