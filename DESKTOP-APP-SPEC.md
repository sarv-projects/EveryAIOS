...
> **Scope (counted from this file's rows):** 151 rows · 34 algorithms (index gains #34 — FSRS was implemented but unnumbered; v3.51; v3.52 adds H33 always-on node + I12 Zed-class IDE). (ARCH/09 mirrors this index; the two are reconciled on change.)
