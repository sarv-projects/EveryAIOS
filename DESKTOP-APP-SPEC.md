...
> **Source ground-truth:** `RESEARCH/desktop_app/` (docs 01–70, **281 repos**, ledger docs 27+46+47+48+49+50+52+54+55+56+57+58+60+61+62+63+64+65+66+67; doc 68 = final all-rounder market research + doc 69 = ACP ecosystem/harness deep-dive + doc 70 = MCP-directory inbuilt analysis, each **0 new repos**) + `desktop_app/ARCH/` (docs 00–12). Everything below traces to those; nothing is invented here.
