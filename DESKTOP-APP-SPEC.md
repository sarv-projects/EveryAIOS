...
> **Source ground-truth:** `RESEARCH/desktop_app/` (docs 01–77, **281 repos**, ledger docs 27+46+47+48+49+50+52+54+55+56+57+58+60+61+62+63+64+65+66+67; doc 68 = final all-rounder market research + doc 69 = ACP ecosystem/harness deep-dive + doc 70 = MCP-directory inbuilt analysis + doc 71 = batch-4 coding agents/skills/harnesses + doc 72 = batch-5 code-intel/parallel/search + doc 73 = batch-6 computer-use/full-control + doc 74 = built-in MCP Server Manager + doc 75 = anthropic skills/plugins/cowork + doc 76 = batch-7 design/browser/self-healing + doc 77 = batch-8 workflows/graphify/browser, each **0 new repos**) + `desktop_app/ARCH/` (docs 00–12). Everything below traces to those; nothing is invented here.
