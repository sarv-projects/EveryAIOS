...
| `TODO.md` | Master implementation checklist (Stage 0 + HARDENING + P0.1 → P12, **1142 = 1055 done + 87 open** (2026-08-26 reconciliation; v3.57 adds post-v1 rows I13 /learn · H35 CLI/doctor · J24 credential-fill + P46.4 ref-invalidation follow-up → P46 queue); **P10.1–P10.5 all landed 2026-08-25/26** — 12 E2E suites + 10 security suites + 14 perf/stress benches (Rust workspace 1901 passed / 18 ignored) + CI matrix/nightly E2E/perf regression/pre-commit + cross-platform detect/portable-vault tests; **P13–P26 batch queues closed 2026-08-24/25** (P14.5 sync automation landed 2026-08-26); **P28/P29/P37/P16/P30/P32/P33/P38–P41 landed 2026-08-24** — P38 Dynamic Chief 7/7 end-to-end, P39 5/5, P40 3/3 (incl. `deploy/` BYO-host pack), P41 4/4; **P42 3/3 + P43 4/4 crate-done 2026-08-26** (UI wiring follow-ons); **v3.56 adds A11 Provider Record + alias layer + H34 Autonomy Level (spec + ARCH/09 + new P44 queue)** — Hermes/OpenCode provider-overlay/alias pattern + Sandbox/Ask/Auto/Max chatbar presets, source-verified 2026-08-26; **P44.1–4 landed 2026-08-26** (catalog provider crate: merge resolver + alias table + OpenAI-compatible profiles + capability-probe verification, catalog 37/37); **P30.16 companion chip + P33.5 LO companion + P33.6 Google Docs browser path + P34.2–4.5/4.7 honest office viewers landed 2026-08-26** (MS-ribbon clones / in-process LOKit deliberately not built per doc-29 verdict); P5 = 71 done + 1 open (LadybugDB FFI deferred); P11.6 UX research + P35 animations landed 2026-08-25; remaining open = P9.2–P9.9 post-v1 (20) + P12 GTM (47) + P44 (5 — P44.5–9) + **P45 (9 — R4-gated micro-perf deltas: SQLite pragmas, audit batch, content-visibility, DNS cache, idle-kill, UI micro-perf)** + **P46 (4 — I13/H35/J24 + ref-invalidation, post-v1)** + P5.2/P6.9; perf-review re-check 2026-08-26 confirmed P29 11/11 + P39 5/5 landed (MessagePack not adopted per R4); spec v3.56 contract (status lives in TODO/SPEC-CHANGELOG) |
