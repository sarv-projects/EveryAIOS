# 27 — MASTER REPO LEDGER (all repos ever added, live-verified 2026-08-06; sections 20–25 added 2026-08-09/10)

> **Every repo ever added across docs 01–56**, deduplicated, **live-verified** (HTTP + `stargazerCount` scraped from github.com). **226 unique repos** (170 through section 19 + 22 in sections 20–21 + 26 in section 22 + 1 in section 23 — LadybugDB, doc 54, 2026-08-09 + 3 in section 24 — agent-browser/obscura/steel-browser, doc 55, 2026-08-10 + 4 in section 25 — warp/cowork-forge/cronflow/copilot-cli, doc 56, 2026-08-10). ⚠️ **ncdu has no GitHub mirror** — canonical host is `dev.yorhel.nl/ncdu` (listed with ⭐ n/a). (context-mode re-verified at 19,654⭐ — doc 32; final-pass §13; workspace/multi-agent §14; composio-community §15; command-code §16; NOOA §17; ACP ecosystem + extension-ABI references §18–19; dependency audit §23).
>
...
## Summary
- **226 repos** tracked (170 through section 19 + 22 in sections 20–21 + 26 in section 22 + 1 in section 23 + 3 in section 24 + 4 in section 25) · **225 live** · **1 transferred** (`LearningCircuit/ai-data-science-team` → `business-science/ai-data-science-team`, 5,369⭐)
