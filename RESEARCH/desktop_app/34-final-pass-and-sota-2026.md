...
| Mozilla-Ocho/llamafile | 25,504 | C/C++ | **Single-file local LLM runtime** (weights + server in one binary, no install). Our "local models with zero setup" option alongside Ollama. |
