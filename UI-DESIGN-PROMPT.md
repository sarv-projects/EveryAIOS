...
- **Agents & models** — Agents & Models · Local models · **Capabilities** (live availability matrix — every advertised surface maps to `live | partial | unavailable | v1-planned | post-v1` with the reason, P50.4.8) · Providers/BYOK (`vault_keys_list`/`add`/`remove`) + custom provider form · Experts/subagents · Launch CLI copy-cards · Chat & Auto-run (**H34: 🛡 Sandbox · 👀 Ask · ⚡ Auto · 🚀 Maximum** + local ctx)
